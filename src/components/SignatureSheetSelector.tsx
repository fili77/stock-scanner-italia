...
const SignatureSheetSelector = () => {
  ...
  // Ottieni gli studenti per il corso selezionato
  const { data: students = [], isLoading } = useQuery({
    queryKey: ['students', selectedCourseId],
    queryFn: () => googleSheetsAPI.getStudents(selectedCourseId),
            ...
            <div ref={printRef} className="border rounded-md p-4">
              <div className="text-center mb-6 print:mb-8">
                ...
                <p className="text-sm text-muted-foreground mb-2">
                  <span className="font-medium">Docente:</span> {getTeacherName(selectedCourseId)}
                </p>
...
export default SignatureSheetSelector;
